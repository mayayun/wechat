...
!function (a, b) {
    ...
    var Y = function (a, b, c, d, e, f, g) {
        ...
        ba = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|figure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|SectionTemplate|summary|template|time|video";
